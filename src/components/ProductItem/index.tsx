const ProductItem = ({ product, onAddToBasket, onRemoveFromBasket, basketQuantity, onRemoveAllFromBasket }: ProductItemProps) => {
            ...
            <div className="flex flex-col gap-y-5">
                ...
                <div className="flex space-x-1">
                    <button
                        ...
                        className="bg-red-500 text-white px-3 py-1 rounded-md hover:bg-red-600 transition-colors w-10"
                    >
                        {"-"}
                    </button>
                    <button
